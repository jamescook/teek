...
class TestRenderer < Minitest::Test
  ...
  tk_test "fill draws a filled rectangle" do
    require "teek/sdl2"
  ...
  tk_test "outline draws a rectangle outline" do
    require "teek/sdl2"
  ...
  tk_test "line draws between two points" do
    require "teek/sdl2"
  ...
  tk_test "blit copies a texture to the renderer" do
    require "teek/sdl2"
  ...
  tk_test "all draw methods work together in one frame" do
    require "teek/sdl2"
  ...
  tk_test "read_pixels returns RGBA buffer matching output size" do
    require "teek/sdl2"
