...
class TestInput < Minitest::Test
  ...
  tk_test "key_down? tracks KeyPress/KeyRelease" do
    require "teek/sdl2"
  ...
  tk_test "multiple keys tracked simultaneously" do
    require "teek/sdl2"
  ...
  tk_test "key_down? is case insensitive" do
    require "teek/sdl2"
  ...
  tk_test "focus gives keyboard focus to viewport" do
    require "teek/sdl2"
  ...
  tk_test "bind delivers events via callback" do
    require "teek/sdl2"
...
class TestFont < Minitest::Test
  ...
  tk_test "font renders text to texture" do
    require "teek/sdl2"
  ...
  tk_test "draw_text renders and blits in one call" do
    require "teek/sdl2"
  ...
  tk_test "font raises on bad path" do
    require "teek/sdl2"
