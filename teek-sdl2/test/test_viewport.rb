...
class TestViewport < Minitest::Test
  ...
  tk_test "viewport should create a renderer" do
    require "teek/sdl2"
  ...
  tk_test "render block should clear and present" do
    require "teek/sdl2"
  ...
  tk_test "event source tracks viewport count" do
    require "teek/sdl2"
  ...
  tk_test "create texture, update pixels, blit" do
    require "teek/sdl2"
