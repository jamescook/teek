...
# Drop Demo - drag files from your file manager onto the window
#
# Demonstrates Teek's native file drop support.
# The label updates to show dropped filenames and sizes.
...
app.command(:label, '.info', text: "Drop files here",
...
app.bind('.', '<<DropFile>>', :data) do |data|
  ...
  app.command('.info', :configure, text: lines.join("\n"))
end
