...
class TestIncrementalRealize < Minitest::Test
  ...
  tk_test "ui.add should create and show new widgets in an already-running app" do
    require 'teek/ui'
  ...
  tk_test "ui.add before the session is realized should raise a clear error" do
    require 'teek/ui'
  ...
  tk_test "ui.add with a name that doesn't exist should raise a clear error" do
    require 'teek/ui'
