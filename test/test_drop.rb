...
class TestDrop < Minitest::Test
  ...
  tk_test "<<DropFile>> should fire callback" do
    fired = false
  ...
  tk_test "<<DropFile>> should receive single file as list" do
    received = nil
  ...
  tk_test "<<DropFile>> should receive multiple files as list" do
    received = nil
  ...
  tk_test "<<DropFile>> should handle paths with spaces" do
    received = nil
  ...
  tk_test "<<DropFile>> should work on child widgets" do
    received = nil
  ...
  tk_test "unbind should remove <<DropFile>> binding" do
    count = 0
