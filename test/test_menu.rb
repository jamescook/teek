...
class TestMenu < Minitest::Test
  ...
  tk_test "a proc added via raw app.command should fire on invoke" do
    fired = false
  ...
  tk_test "rebuilding a menu via raw app.command should not grow callback count" do
  ...
  tk_test "insert/entryconfigure/partial-delete via raw app.command should reconcile by live value, not index" do
  ...
  tk_test "destroying a menu should release all its tracked callbacks, built via raw app.command" do
  ...
  tk_test "clearing a menu then destroying it should not error or double-release, via raw app.command" do
  ...
  tk_test "a menu rebuilt at a reused path should not inherit stale tracking, via raw app.command" do
