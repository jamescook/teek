...
class TestPhoto < Minitest::Test
  ...
  tk_test "Photo auto-generates unique names" do
  ...
  tk_test "Photo accepts explicit name" do
  ...
  tk_test "Photo constructor sets dimensions" do
  ...
  tk_test "Photo exist? and delete" do
  ...
  tk_test "put_block writes pixels, get_image reads them back" do
  ...
  tk_test "put_block with offset writes to correct region" do
  ...
  tk_test "put_block returns self for chaining" do
  ...
  tk_test "put_block rejects wrong data size" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "put_block rejects zero dimensions" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "put_block handles transparent pixels" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "put_block ARGB format maps channels correctly" do
  ...
  tk_test "put_block ARGB red pixel" do
    p = Teek::Photo.new(app, width: 1, height: 1)
  ...
  tk_test "composite :set overwrites existing pixels" do
    p = Teek::Photo.new(app, width: 1, height: 1)
  ...
  tk_test "composite :overlay alpha-blends over existing" do
    p = Teek::Photo.new(app, width: 1, height: 1)
  ...
  tk_test "put_zoomed_block 3x zoom" do
  ...
  tk_test "put_zoomed_block asymmetric zoom" do
  ...
  tk_test "put_zoomed_block returns self" do
  ...
  tk_test "get_image unpack returns integer array" do
  ...
  tk_test "get_image reads a sub-region" do
    p = Teek::Photo.new(app, width: 20, height: 20)
  ...
  tk_test "get_pixel reads exact RGBA values" do
  ...
  tk_test "get_pixel rejects out-of-bounds coordinates" do
    p = Teek::Photo.new(app, width: 5, height: 5)
  ...
  tk_test "get_size returns correct dimensions" do
  ...
  tk_test "set_size changes dimensions" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "set_size returns self" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "expand increases dimensions on auto-sized photo" do
  ...
  tk_test "expand does not shrink" do
    p = Teek::Photo.new(app)
    p.put_block([0, 0, 0, 255].pack('CCCC') * 400, 20, 20)
  ...
  tk_test "expand is no-op when photo has explicit -width/-height" do
  ...
  tk_test "expand returns self" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "blank clears image to transparent" do
    p = Teek::Photo.new(app, width: 10, height: 10)
  ...
  tk_test "clear is alias for blank" do
    p = Teek::Photo.new(app, width: 5, height: 5)
  ...
  tk_test "write and read multi-color pattern" do
