...
class TestPackage < Minitest::Test
  ...
  tk_test "require_package should load package and return version" do
  ...
  tk_test "require_package with version should work" do
    fixtures = File.join(Dir.pwd, 'test', 'fixtures')
    app.tcl_eval("lappend ::auto_path {#{fixtures}}")
  ...
  tk_test "require_package should raise on missing package" do
  ...
  tk_test "package_names should return array of available packages" do
    names = app.package_names
    assert_kind_of Array, names
    assert_includes names, 'Tk'
  end

  tk_test "package_present? should detect loaded packages" do
  ...
  tk_test "package_versions should return available versions" do
    fixtures = File.join(Dir.pwd, 'test', 'fixtures')
  ...
  tk_test "add_package_path should make packages loadable" do
    fixtures = File.join(Dir.pwd, 'test', 'fixtures')
    app.add_package_path(fixtures)
  ...
  tk_test "add_package_path should append to auto_path" do
