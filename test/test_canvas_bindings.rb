...
class TestCanvasBindings < Minitest::Test
  ...
  tk_test "a proc bound to an item id via raw app.command should still actually fire" do
  ...
  tk_test "rebinding the same item+event via raw app.command should not grow callback count" do
  ...
  tk_test "clearing an item binding via raw app.command should release the callback" do
  ...
  tk_test "deleting a bound item via raw app.command should release its callback" do
  ...
  tk_test "deleting an item bound with %-substitution codes should still release its callback" do
  ...
  tk_test "a tag binding via raw app.command should survive deleting the tagged item" do
  ...
  tk_test "an item id binding and a tag binding via raw app.command should be tracked independently" do
  ...
  tk_test "destroying a canvas should release all its tracked item/tag binding callbacks" do
