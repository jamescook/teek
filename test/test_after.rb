...
class TestAfter < Minitest::Test
  ...
  tk_test "after should fire callback" do
    fired = false
  ...
  tk_test "after_idle should fire callback" do
    fired = false
  ...
  tk_test "after_cancel should prevent callback" do
    fired = false
  ...
  tk_test "nested timers should both fire" do
    results = []
